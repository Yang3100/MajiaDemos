...
//    bar.barTintColor = ThemeColorString(@"MainColor"); //  导航背景颜色
    [bar setTheme_barTintColor:@"navigation_bg_color"];
    // 隐藏了系统的 自己添加了一个分割线
    // 隐藏系统的导航栏分割线
    ...
    navSystemLine.theme_backgroundColor = @"navigation_bg_color";
//    navSystemLine.backgroundColor = ThemeColorString(@"MainColor"); //[[UIColor blackColor] colorWithAlphaComponent:.1];
...
//    [appearance setTintColor:[UIColor whiteColor]];
    [appearance setTheme_barTintColor:@"navigation_title_color"];
    // 设置导航栏的背景渲染色
    // 设置导航栏的背景渲染色
    CGFloat rgb = 0.1;
...
- (UIStatusBarStyle)preferredStatusBarStyle{
    if ([[SDThemeManager sharedInstance].themeName isEqualToString:@"KJTheme-Black"]) {
