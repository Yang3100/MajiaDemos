...
- (void)viewDidLoad {
    ...
    [self setupChildVC:homeNav title:@"画廊" image:@"huaban_nor" selectedImage:@"huaban"];
    [self setupChildVC:drawNav title:@"橱窗" image:@"chuchuang_nor" selectedImage:@"chuchuang"];
