...
@interface WMPageController () {
    ...
    CGFloat kj_top_view_x,kj_top_view_width;
}
...
- (void)setIsOpenScroll:(BOOL)isOpenScroll{
    _isOpenScroll = isOpenScroll;
    self.scrollView.scrollEnabled = isOpenScroll;
}

- (void)setNavigationBarNum:(NSInteger)navigationBarNum{
    if (navigationBarNum) {
        kj_top_view_x = 44;
        kj_top_view_width = [UIScreen mainScreen].bounds.size.width - 88;
    }
    else if (navigationBarNum==2){
        kj_top_view_x = 44;
        kj_top_view_width = [UIScreen mainScreen].bounds.size.width - 88;
    }
    else{ // 默认
        kj_top_view_x = 0;
        kj_top_view_width = [UIScreen mainScreen].bounds.size.width;
    }
}
...
- (void)addScrollView {
    ...
    scrollView.scrollEnabled = _isOpenScroll;
...
- (void)adjustMenuViewFrame {
    ...
    __block CGFloat menuX = kj_top_view_x;
    ...
    CGFloat menuWidth = kj_top_view_width - menuX - rightWidth;
