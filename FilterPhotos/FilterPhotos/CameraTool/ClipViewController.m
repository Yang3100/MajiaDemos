...
- (void)createdTkImageView{
    _tkImageView = [[TKImageView alloc] initWithFrame:CGRectMake(0, 0, SelfWidth, SelfHeight - 100)];
...
- (void)createdTool{
    UIView  *editorView = [[UIView alloc] initWithFrame:CGRectMake(0, SelfHeight - 100, SelfWidth, 100)];
