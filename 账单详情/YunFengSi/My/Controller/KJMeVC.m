    ...
    if ([kind isEqualToString:CHTCollectionElementKindSectionFooter]) {
        ...
        if (indexPath.section==0) {
            if (reusableView.subviews.count == 0) {//加一个限制，避免无限创建新的
                ...
                UIImageView*headerImageView = InsertImageView(reusableView, CGRectZero, GetImage(@"jita"));
                ...
                UILabel*Label=InsertLabel(reusableView, CGRectZero, NSTextAlignmentLeft, @"这里就是一段简介..", SystemFontSize(12), [UIColor whiteColor]);
    ...
    if (indexPath.section == 1) {
        switch (indexPath.row) {
            ...
            case 5:{ // 关于我们
                ...
                break;
            case 6:{ //   给我们评分
                NSString *urlStr = [NSString stringWithFormat:@"itms-apps://itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?type=Purple+Software&id=%@&pageNumber=0&sortOrdering=2&mt=8", @"1439555388"];
