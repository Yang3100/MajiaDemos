...
//*****************  颜色相关  *******************
// center
@property(nonatomic,strong) UIColor *viewColor;  // 视图颜色
...
- (void)createAlertViewCenter {
    ...
    _centerView.backgroundColor = self.viewColor;
...
- (void)createAlertViewBottom{
    ...
    _bottomView = [[UITableView alloc] initWithFrame:CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, self.titleArray.count*Handle_height(50)+Handle_height(10)+BOTTOM_SPACE_HEIGHT+bottomHeader) style:UITableViewStyleGrouped];
...
- (UIView*)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    if (section==0) {
        ...
        titleLab.text = self.title;
        titleLab.backgroundColor = UIColorFromHEXA(0xffffff,1.0);
        titleLab.textColor = UIColorFromHEXA(0x343434,1.0);
        titleLab.textAlignment = NSTextAlignmentCenter;
        titleLab.font = SystemFontSize(15);
        UIView *line = [[UIView alloc]initWithFrame:CGRectMake(2, Handle_height(50), SCREEN_WIDTH-4, 1)];
        line.backgroundColor = UIColorFromHEXA(0xe8e4e5,0.7);
    ...
    if ([self.type isEqualToString:@"center"]) {
        ...
        [UIView animateWithDuration:0.25 animations:^{
            weakself.bottomView.frame = CGRectMake(0,
                                                   SCREEN_HEIGHT - weakself.titleArray.count * Handle_height(50) - Handle_height(10) - BOTTOM_SPACE_HEIGHT - self->bottomHeader,
                                                   SCREEN_WIDTH,
                                                   weakself.titleArray.count * Handle_height(50) + Handle_height(10) + BOTTOM_SPACE_HEIGHT + self->bottomHeader);
        }];
    }
}
...
- (void)dissmis{
    if ([self.type isEqualToString:@"center"]) {
        ...
        _weakself;
        [UIView animateWithDuration:0.25 animations:^{
            weakself.bottomView.frame = CGRectMake(0, SCREEN_HEIGHT, SCREEN_HEIGHT, self.titleArray.count*Handle_height(50)+Handle_height(10)+BOTTOM_SPACE_HEIGHT);
