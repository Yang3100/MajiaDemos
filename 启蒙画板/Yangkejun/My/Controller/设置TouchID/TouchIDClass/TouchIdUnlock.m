...
- (void)startVerifyTouchID:(void (^)(void))completionBlock
{
    ...
    if (_reasonThatExplainAuthentication.length) {myLocalizedReasonString = _reasonThatExplainAuthentication;
    }
    ...
    {/**
        ...
        [myContext evaluatePolicy:LAPolicyDeviceOwnerAuthenticationWithBiometrics
                  localizedReason:myLocalizedReasonString
                            reply:^(BOOL success, NSError *error) {                        if (success) {                            // User authenticated successfully, take appropriate action
...
- (void)showAlertIfUserDenied
{
    ...
    if (_alertMessageToShowWhenUserDisableTouchID.length) {msg = _alertMessageToShowWhenUserDisableTouchID;
    }
