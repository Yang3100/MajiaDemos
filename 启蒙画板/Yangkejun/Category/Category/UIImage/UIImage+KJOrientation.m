...
#import "UIImage+KJOrientation.h"

@implementation UIImage (KJOrientation)
/**
 *  将图片旋转到指定的方向
 *
 ...
 *  @return 返回旋转后的图片
 */
+ (UIImage *)kj_fixImageOrientationWithSourceImage:(UIImage *)sourceImage orientation:(UIImageOrientation)orientation{
...
+ (UIImage *)kj_fixOrientation:(UIImage *)aImage{
