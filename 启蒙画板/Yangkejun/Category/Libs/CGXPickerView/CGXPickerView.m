...
+ (void)black:(CGXDateResultBlock)black{
...
+ (void)showAddressPickerWithTitle:(NSString *)title
                   DefaultSelected:(NSArray *)defaultSelectedArr
                      ...
                      IsAutoSelect:(BOOL)isAutoSelect
                           Manager:(CGXPickerViewManager *)manager
                       ResultBlock:(CGXAddressResultBlock)resultBlock{
    [CGXAddressPcikerView showAddressPickerWithTitle:title DefaultSelected:defaultSelectedArr DataArray:dataArray IsAutoSelect:isAutoSelect Manager:manager ResultBlock:^(NSArray *selectAddressArr, NSArray *selectAddressRow) {
        if (resultBlock) {
            resultBlock(selectAddressArr,selectAddressRow);
        }
    }];
//    [CGXAddressPcikerView showAddressPickerWithTitle:title DefaultSelected:defaultSelectedArr FileName:@"" IsAutoSelect:isAutoSelect Manager:manager ResultBlock:^(NSArray *selectAddressArr, NSArray *selectAddressRow) {
//        if (resultBlock) {
//            resultBlock(selectAddressArr,selectAddressRow);
//        }; ;
//    }];
