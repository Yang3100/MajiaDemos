...
- (CGSize)kj_sizeWithFont:(UIFont *)font limitSize:(CGSize)limitSize{
    CGSize theSize;
    NSDictionary *attributes = [NSDictionary dictionaryWithObject:font forKey:NSFontAttributeName];
...
- (CGSize)kj_sizeWithFont:(UIFont *)font limitWidth:(CGFloat)limitWidth{
    return [self kj_sizeWithFont:font limitSize:CGSizeMake(limitWidth, MAXFLOAT)];
}
