...
- (void)_setup{
    ...
    //    [KJTools makeCornerRadius:0 borderColor:ThemeColorString(@"MainColor") layer:self.layer borderWidth:0.3];
}
...
- (void)_setupSubViews{
    ...
    titleLabel.theme_textColor = @"text_h1";
    ...
    [rightImageView setTheme_image:@"Arrow"];
    ...
    [line mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(self.contentView.frame.size.height/5);
    }];
}
...
- (void)_makeSubViewsConstraints{
    [self.imageView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.mas_equalTo(self.contentView).mas_offset(self.contentView.frame.size.height/10);
