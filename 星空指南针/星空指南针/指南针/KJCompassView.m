...
- (void)createPointer{
    ...
    [pointerImageView setImage:[UIImage imageNamed:@"1"]];
...
- (void)setHorizontalColor:(UIColor *)horizontalColor{
    ...
    _horizontalView.backgroundColor = [UIColor colorWithCGColor:CGColorCreateCopyWithAlpha(_horizontalColor.CGColor, 0.7)];
}
