...
- (UIView*)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    if (section==0) {
        ...
        titleLab.text = self.title;
        titleLab.backgroundColor = [self.bottomViewColor colorWithAlphaComponent:0.5];
        titleLab.textColor = self.titleColor;
        titleLab.textAlignment = NSTextAlignmentCenter;
        titleLab.font = SystemFontSize(15);
...
- (void)show{
    if ([self.type isEqualToString:@"center"]) {
        ...
        [UIView animateWithDuration:0.25 animations:^{
            weakself.bottomView.frame = CGRectMake(0, SCREEN_HEIGHT - weakself.titleArray.count * Handle_height(50) - Handle_height(10) - BOTTOM_SPACE_HEIGHT - self->bottomHeader, SCREEN_WIDTH, weakself.titleArray.count * Handle_height(50) + Handle_height(10) + BOTTOM_SPACE_HEIGHT + self->bottomHeader);
        }];
    }
}
