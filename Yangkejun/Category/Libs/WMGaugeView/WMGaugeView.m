...
- (void)initialize;
{
    ...
    _scaleDivisionColor = [UIColor whiteColor];
    _scaleSubDivisionColor = RGB(217, 217, 217);
    //    [UIColor colorWithRed:217/255.0 green:217/255.0 blue:217/255.0 alpha:1]
...
#define SHADOW_OFFSET  0.008
            ...
            //            [UIColor colorWithRed:255/255.0 green:104/255.0 blue:97/255.0 alpha:1]
...
- (void)drawNeedleScrew:(CGContextRef)context
{
    switch (_needleScrewStyle)
    {
        ...
        case WMGaugeViewNeedleScrewStylePlain:
        {
            ...
            //            [UIColor colorWithRed:68/255.0 green:84/255.0 blue:105/255.0 alpha:1];
            CGContextFillPath(context);
        }
            break;
