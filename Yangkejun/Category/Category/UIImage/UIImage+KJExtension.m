...
static NSTimeInterval const KJThumbnailImageTime = 10.0f;
...
+ (UIImage *)kj_resizableImage:(NSString *)imgName{
    return [self kj_resizableImage:imgName xPos:0.5 yPos:0.5];;
}
...
+ (UIImage *)kj_getVideoFirstThumbnailImageWithVideoUrl:(NSURL *)videoUrl{
    ...
    CFTimeInterval thumbnailImageTime = KJThumbnailImageTime;
